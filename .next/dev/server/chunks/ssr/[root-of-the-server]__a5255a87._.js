...
async function getSeasonMetadata() {
    try {
        const seasonMetaPath = __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$path__$5b$external$5d$__$28$node$3a$path$2c$__cjs$29$__["default"].join(process.cwd(), "public", "data", "season_metadata.json");
        const text = await __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$fs$2f$promises__$5b$external$5d$__$28$node$3a$fs$2f$promises$2c$__cjs$29$__["default"].readFile(seasonMetaPath, "utf8");
...
async function PicksPage({ searchParams }) {
    ...
    const [csvIndex, seasonMetadata] = await Promise.all([
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dataAvailability$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCsvDateIndex"])(),
        getSeasonMetadata()
    ]);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a5255a87._.js.map