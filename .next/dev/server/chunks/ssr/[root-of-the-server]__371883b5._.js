...
async function PicksPage({ searchParams }) {
    ...
    const csvIndex = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dataAvailability$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCsvDateIndex"])();
    const requestedDate = (params.date ?? "").trim();
    const effectiveDate = requestedDate && csvIndex.dates.includes(requestedDate) ? requestedDate : csvIndex.maxDate || "";
    let picksData;
    try {
        picksData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$baseline$2f$fetchBaselineHrPicks$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["fetchBaselineHrPicks"])(effectiveDate);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__371883b5._.js.map